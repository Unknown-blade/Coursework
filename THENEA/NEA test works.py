...
from Spriteloader_x import loadSprite_x #custom library
...
#give values as the height and width of individual sprites so as to avoid further uneccesary calculations and reduce confusion between variables.
def spritesheet_loader(spritesheet,width,height,spriteno,scale_factor):
    y_cor = height * spriteno
    sprite_img = pygame.Surface((width,height)).convert_alpha()
    sprite_img.blit(spritesheet,(0,0),(y_cor-height,0,y_cor,width))
